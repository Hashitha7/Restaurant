        ...
        <div class="row center-middle">
            ...
            <div class="col-md-15" style="margin-left: 17rem; margin-top: 0rem;max-height: 700px; overflow-y: auto;">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($latestBillData) {
                            ...
                            if ($result2 && mysqli_num_rows($result2) > 0) {
                                $billItemColor = 'yellow)'; // Bill has associated bill items (yellow)
                            } else {
                                $billItemColor = 'blue'; // Bill has no associated bill items (blue))
                            }
                            ...
                            $box_color = $hasPaymentTime ? 'Blue' : $billItemColor;
                        } else {
                            $latestBillID = null;
                            $box_color = 'pink'; // No bill for the table (pink)
                        }
                        ...
                        if ($reservationResult && mysqli_num_rows($reservationResult) > 0) {
                            ...
                            echo '<a href="orderItem.php?bill_id=' . $latestBillID . '&table_id=' . $table_id . '"class="btn btn-primary btn-block btn-lg" style="color:black; '
                                    . 'background-color: blue;justify-content: center; align-items: center; display: flex; width: 9rem; height: 9rem;">'
              ...
              <div class="row d-flex justify-content-around"style="margin-top: 2rem;" >
                <div class="col-md-3">
                    <div class="alert alert-success" role="alert" style="color:white;background-color: blue;" data-toggle="tooltip" data-placement="top" title="Tables That are Free">
                        Available
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="alert alert-danger" role="alert" style="color:white;background-color: orange;" data-toggle="tooltip" data-placement="top" title="Tables That are Used">
                        Occupied
                    </div>
                </div>
                <!--
                ...
                -->
                <div class="col-md-3">
                    <div class="alert alert-warning" style="color:black;background-color: green;" role="alert" data-toggle="tooltip" data-placement="top" title="Tables That are Reserved">
                        Reserved
                    </div>
                     </div>
                </div>
