  ...
  max-width: 500px; /* Set a maximum width for the container */
        ...
        body {
            ...
            background-color:black;
             background-image: url('../image/L1.jpg'); /* Set the background image path */
...
<body>
    ...
    <div class="login_wrapper">
        <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> The Gallery Cafe </h1><span class="sr-only"></span></a>
    ...
    <span class="text-danger"><?php echo $password_err; ?></span>
            ...
            <p style="margin-top:1em; color:white;">Don't have an account? <a href="register.php" style="background-color:black;">Proceed to Register</a></p>
        </div>
    </div>
    </div>
</body>
