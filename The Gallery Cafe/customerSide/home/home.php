    ...
    <div class="nav-bar">
      <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> The Gallery Cafe</h1><span class="sr-only"></span>
          </a>
      </div>
      <div class="nav-list">
        <div class="hamburger">
          ...
          <div class="navbar-container" style="color: #fff;">
...
<section id="hero" style="position: relative;">
    <video autoplay loop muted playsinline poster="your-poster-image.jpg" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;">
        <source src="../image/food menu.mp4" type="video/mp4">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
        <div>
            <h1><strong><h1 class="text-center" style="font-family:Copperplate; color:blue;"></h1><span></span></strong></h1>
            <h1><strong style="color:blue;"><span></span></strong></h1>
...
<!-- End Hero Section -->
  ...
  <!-- menu Section -->
  <section id="projects" style="background: linear-gradient(90deg, rgb(173, 173, 189), #e5b4b4);">
  ...
  <!-- About Section -->
<section id="about" style="background-image:url(../image/ab1.webp); background-repeat: no-repeat; background-position: center; background-size: cover;">
  <div class="about container">
    <div class="col-right" style="font-family: Roboto Slab serif";>
      
        <h1 class="section-title" >About <span>Us</span></h1>
        
        
 <p>The Gallery Cafe is one of the best restaurants in Colombo boasts an opulent ambience with an elegant outdoor seating. Its menu incorporates extensive varieties of cuisines like Indian, Italian, and Sri Lankan dishes to satisfy every palate. Desserts are the USP of this cafe as it serves  different types of desserts, which have an unrivaled taste throughout Sri Lanka.
 </p>
 <p>The Gallery Cafe's flexibility to accommodate customers is one of its defining traits. Whether customers choose to book in advance or come in, The Gallery Cafe aims to deliver a warm and welcoming dining experience. The restaurant understands how important it is to make customers' experiences unforgettable, especially when they are commemorating special anniversaries. The Gallery Cafe's friendly atmosphere and attentive personnel make it a popular choice for families, couples, and groups of friends.
 </p>
 <p>As a restaurant in Colombo, The Gallery Cafe has a varied cuisine to suit different palates. There are many different options on the menu, including salads, soups, bar nibbles and several major dishes. Savoury selections include spaghetti, burgers & sandwiches, seafood, Fried Rice, Kottu, and an array of mouthwatering side dishes. To ensure that every palette is pleased, the menu has been thoughtfully chosen to provide a blend of traditional favourites and creative inventions.
 </p>
 <p>Daily 12 noon to 10.30 PM Closed on Poya Days (Full Moon Holidays)
 </p>
 ...
 <!-- Contact Section -->
<section id="contact"  style="font-family: Merriweather, serif;background-image: url(../image/ffff.jpeg);">
    ...
    <div class="contact-items">
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          <div class='icon'><img src="../image/phone-solid.svg" alt=""/></div>
          <h1>PHONE</h1>
          <h2>+94 72 458 7896</h2>
        </div>
      </div>
      
      <div class="contact-item contact-item-bg"> 
        <div class="contact-info">
          <div class='icon'><img src="../image/envelope-solid.svg" alt=""/></div>
          <h1>EMAIl</h1>
          <h2>hashidanidu@gmail.com</h2> 
        </div>
      </div>
      
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          <div class='icon'> <img src="../image/location-dot-solid.svg" alt=""/></div>
          <h1>Address</h1>
          <h2>No 24, wilfread Road, Colombo, 81000</h2>
        </div>
      </div>
    </div>
  </div>
