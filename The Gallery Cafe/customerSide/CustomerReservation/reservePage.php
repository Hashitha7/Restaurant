...
<body>
    <?php
        ...
        if ($reservationStatus === 'success') {
            ...
            '<h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">Gallery Cafe\'S</h1>' .
    ...
    <div class="reserve-container"style="background-image:url(../image/teaback.webp);padding: 30px;">
        <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family: Copperplate; color: black;">The Gallery Cafe</h1>
